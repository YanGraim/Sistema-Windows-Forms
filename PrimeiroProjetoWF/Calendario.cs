...
namespace PrimeiroProjetoWF {
    public class Calendario : DateTimePicker {
        private Color skinColor = Color.FromArgb(27, 25, 22);
        private Color textColor = Color.Silver;
        private Color borderColor = Color.FromArgb(231, 119, 48);
        private int borderSize = 0;


        private bool droppedDown = false;
        private Image calendarIcon = Properties.Resources.icons8_calendário_16;
        ...
        public Color SkinColor {
            ...
            set {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.icons8_calendário_16;
                else calendarIcon = Properties.Resources.icons8_calendário_16;
                this.Invalidate();
            }
        }
